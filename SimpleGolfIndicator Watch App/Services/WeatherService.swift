...
struct WeatherData {
    ...
    init(from openWeather: OpenWeatherResponse) {
        self.temperature = openWeather.main.temp
        self.rawWindDegrees = Double(openWeather.wind.deg)
        self.windDirection = Self.getWindDirection(Double(openWeather.wind.deg))
        ...
        self.feelsLike = openWeather.main.feels_like
    }
